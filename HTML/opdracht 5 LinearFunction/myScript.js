...
let startPoint = new Point(new Vector2d(50,line1.calcY(0)),20, "rgba(237, 214, 195, -4)");
let endPoint = new Point(new Vector2d(1500,line1.calcY(0)),20, "rgba(237, 214, 195, -4)");
...
function animate(){
  ...
  startPoint.position.dy = line1.calcY(0);
  ...
  context.strokeStyle = 'rgb(134, 193, 181)';
  context.stroke();
